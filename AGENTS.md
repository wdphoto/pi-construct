...
- Dashboard Right Arrow on a package row unfolds read-only package-contained resources inline using Pi's native resolver; Left Arrow folds, and `i` opens details. It does not write package filters yet.
