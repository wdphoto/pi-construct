...
- [x] Extend package resource picking to Available rows: inspect remembered sources with Pi's temporary resolver, then install project-local with selected resources only.
