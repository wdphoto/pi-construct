...
- **Resource filters:** package object filters can disable resources in subtle ways. Construct package rows are whole-package toggles for now; it does not preserve partial package filters.
